...
//API
import { getClassroomByPool } from "@services/Api/pool.api";
export default function ClassDetails({
    ...
    useEffect(() => {
        async function fetch() {
            ...
            const MentorRes = await getClassroomByPool({
                batch_id: batch_id,
                slots: daySlotsArray,
        ...
        <SidePane position="right" padding="0" width="28%">
            <div className={style.container}>
                ...
                <span className={style.MentorHeader}>
                    ...
                    <p className={style.MentorSubjectText}>{data.course}</p>
                </span>
                {/* Class Details */}
                <span
                ...
                >
                    <span className={style.MentorBrief}>
                        ...
                        <p>{data.capacity || " --  "}</p>
                        <p>City :</p>
                        <p>{data.city_name || " Gurgaon  "}</p>
                        <p>centre :</p>
                        <p>{data.centre_name || " --  "}</p>
                    </span>
                </span>
